...
Во всей работе **EraSeMap является одним алгоритмом с пятью публичными этапами**: карта,
обнаружение, минимизация, проверка во времени и сертификат. PCUG, GhostGraph, CDC, RSE, MSC и TRE —
это внутренние представления, решатели и названия экспериментов, сохранённые для воспроизводимости,
а не отдельные продукты или конкурирующие алгоритмы верхнего уровня.
...
### 7.12 Уровень K: model channel на реальных Qwen–TOFU
