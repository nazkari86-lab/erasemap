...
Публичный репозиторий содержит код, зафиксированные протоколы, исходные записи, манифесты, отчёты, доказательства Lean и настройки непрерывной интеграции. Доказательная база, оцениваемая в работе, сохранена в публичной истории версии 0.3.1; манифесты протоколов и исходных записей содержат криптографические хэши. Основные команды:
...
[14] EraSeMap. Публичный репозиторий и архив доказательств, версия 0.3.1, 2026: https://github.com/nazkari86-lab/erasemap.
