...
Репозиторий содержит 240 тестов с покрытием 90,30% по полной CI-equivalent команде, locked protocols, raw records, manifests, preregistrations, отчёты об отрицательных результатах, Lean-проект, CLI-демонстрации и CI gates. Инженерная проверка повышает воспроизводимость, но не считается независимой научной валидацией.
