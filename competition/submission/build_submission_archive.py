...
FILES: tuple[tuple[Path, str], ...] = (
    ...
    (SUBMISSION / "Nurlanuly_Dulat_EraSeMap_Otzyv_Rukovoditelya_SIGNED_FINAL.pdf", "05_Otzyv_Rukovoditelya_SIGNED_FINAL.pdf"),
    (SUBMISSION / "Nurlanuly_Dulat_EraSeMap_Registration_Data_DRAFT.docx", "06_Registration_Data_REFERENCE.docx"),
    (SUBMISSION / "Nurlanuly_Dulat_EraSeMap_Registration_Data_DRAFT.pdf", "06_Registration_Data_REFERENCE.pdf"),
    ...
    (ROOT / "outputs" / "jury-showcase-v1" / "index.html", "Demo/Verification/index.html"),
    (ROOT / "outputs" / "jury-showcase-v1" / "report.json", "Demo/Verification/report.json"),
)
