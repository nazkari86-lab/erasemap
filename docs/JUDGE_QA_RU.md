...
В зафиксированном v1 было 7 случаев: 3 графа восстановлены точно, один возвращён полным
двухграфовым path class, внешний граф обнаружен как OUT, нарушение изоляции — как UNVERIFIED.
Ложных уверенных ответов 0; потребовалось 6 probes вместо 49 exhaustive case-probes. Это
project-authored bounded experiment, не тест eGov/FaceID и не независимая проверка.
