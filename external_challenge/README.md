...
4. EraSeMap produces answer-blind records once and runs `seal.py freeze`; missing, duplicate, or
   extra case IDs are rejected and the predictions receive their own commitment.
