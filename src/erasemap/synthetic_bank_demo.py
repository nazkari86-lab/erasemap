...
def build_synthetic_bank_demo() -> dict[str, Any]:
    ...
    return {
        ...
        "steps": [
            ...
            {
                "id": "discover",
                "title": "Stage 2 discovers the cause",
...
<body>
  <!-- GhostGraph is the internal reproducibility label for EraSeMap stage 2; the public algorithm is EraSeMap. -->
  <main class="app">
