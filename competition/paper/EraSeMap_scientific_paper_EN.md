...
Throughout this paper, **EraSeMap is one algorithm with five public stages**: map, discover,
minimize, verify over time, and certify. PCUG, GhostGraph, CDC, RSE, MSC, and TRE are internal
representations, solvers, and experiment names retained for reproducibility, not separate products
or competing top-level algorithms.
